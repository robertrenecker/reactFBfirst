...
let _validateAssetFieldsAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (projectRoot, exp) {
    try {
  ...
  return function _validateAssetFieldsAsync(_x5, _x6) {
    return _ref4.apply(this, arguments);
  };
})();

let _validatePackageJsonAndExpJsonAsync = (() => {
  var _ref6 = _asyncToGenerator(function* (exp, pkg, projectRoot) {
    if (!exp || !pkg) {
  ...
  return function _validatePackageJsonAndExpJsonAsync(_x8, _x9, _x10) {
...
let _validateNodeModulesAsync = (() => {
  ...
  return function _validateNodeModulesAsync(_x11) {
...
let validateLowLatencyAsync = exports.validateLowLatencyAsync = (() => {
  ...
  return function validateLowLatencyAsync(_x12) {
...
let validateWithNetworkAsync = exports.validateWithNetworkAsync = (() => {
  ...
  return function validateWithNetworkAsync(_x13) {
...
let validateAsync = (() => {
  var _ref10 = _asyncToGenerator(function* (projectRoot, allowNetwork) {
    ...
    let newStatus = yield _validatePackageJsonAndExpJsonAsync(exp, pkg, projectRoot);
    if (newStatus > status) {
      status = newStatus;
    }
  ...
  return function validateAsync(_x14, _x15) {
...
let getExpoSdkStatus = exports.getExpoSdkStatus = (() => {
  ...
  return function getExpoSdkStatus(_x16) {
